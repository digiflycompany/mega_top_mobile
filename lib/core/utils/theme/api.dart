class EndPoints {
  ...
  static const String brandsAPI = '$baseUrl/api/v1/brands';
  ...
  static const String lastOfferAPI = '$baseUrl/api/v1/products?isOffer=true';
  static const String userAddressesAPI = '$baseUrl/api/v1/addresses/';
  static const String addAddressAPI = '$baseUrl/api/v1/addresses';
  ...
  static const String homeScreenAddsAPI =
      '$baseUrl/api/v1/advertisements?isSlider=true';
  static const String selectedCategoriesAPI = '$baseUrl/api/v1/products';
  static const String subCategoriesAPI = '$baseUrl/api/v1/subcategories';

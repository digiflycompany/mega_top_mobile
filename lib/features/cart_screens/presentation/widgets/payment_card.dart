...
class PaymentCard extends StatelessWidget {
  ...
  const PaymentCard(
      {super.key, this.paymentIcon, this.paymentType, required this.isSelected, required this.value});
        ...
        return Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                  color: isSelected?AppColors.primaryColor:AppColors.smallContainerGreyColor, width: 1.w),
